...
from pyspark.sql.functions import SparkContext,StructType,col,split,lit,current_timestamp,from_unixtime
...
if __name__=='__main__':
    ...
    upload_data=util.upload_data_to_gcs(bucket_name='earthquake_analysissd',url_data=data,destination_blob_name=f'pyspark/landing/{current_date}/Daily_data.json')

    # ======================================================================
    # Read the data from the GCS
    read_data=util.read_from_gcs('earthquake_analysissd',f'pyspark/landing/{current_date}/Daily_data.json')
    ...
    gcs_path = f"gs://earthquake_analysissd/Silver/{current_date}/Daily.parquet"
    ...
    # print('Daily data successfully Loaded into Bigquery..!!')
